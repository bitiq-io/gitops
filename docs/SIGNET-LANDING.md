...
- Image: `quay.io/paulcapestany/signet-landing:0.1.0` (multi-stage build, nginx-unprivileged on :8080). A GitHub Actions workflow in the app repo builds/pushes tags.
