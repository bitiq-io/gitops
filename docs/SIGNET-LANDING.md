...
- Image: `quay.io/paulcapestany/signet-landing:0.1.2` (multi-stage build, nginx-unprivileged on :8080, multi-arch). A GitHub Actions workflow in the app repo builds/pushes tags to Quay (repo is public; pull secret optional).
