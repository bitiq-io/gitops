...
| OpenShift AI (RHOAI) | `rhods-operator` (Red Hat) | `fast-3.x` | `rhods-operator.3.0.0` | `oc get csv -n openshift-operators --selector=operators.coreos.com/rhods-operator.openshift-operators` | https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.0 |
...
| OpenShift AI vLLM runtime | `vLLM 0.11.0 (CUDA)` | `oc get servingruntimes -A \\| rg -i vllm`<br>`oc get clusterservingruntimes \\| rg -i vllm` | https://access.redhat.com/articles/rhoai-supported-configurations |
