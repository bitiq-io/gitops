...
CHARTS := charts/bootstrap-operators charts/argocd-apps charts/bitiq-umbrella charts/image-updater charts/ci-pipelines charts/toy-service charts/toy-web charts/strfry charts/ollama charts/openshift-ai charts/signet-llm charts/signet-embeddings charts/signet-loadtest charts/nostr-query charts/nostr-threads charts/nostr-thread-copier charts/nostouch charts/vault-runtime charts/vault-config charts/vault-dev charts/nostr-site charts/couchbase-cluster charts/cluster-capacity
...
lint: ## helm lint all charts
	@for c in $(CHARTS); do \
	  echo "==> helm lint $$c"; \
	if [ "$$c" = "charts/toy-service" ] || [ "$$c" = "charts/toy-web" ] || [ "$$c" = "charts/nostr-site" ] || [ "$$c" = "charts/couchbase-cluster" ] || [ "$$c" = "charts/strfry" ] || [ "$$c" = "charts/ollama" ] || [ "$$c" = "charts/openshift-ai" ] || [ "$$c" = "charts/signet-llm" ] || [ "$$c" = "charts/signet-embeddings" ] || [ "$$c" = "charts/signet-loadtest" ] || [ "$$c" = "charts/nostr-query" ] || [ "$$c" = "charts/nostr-threads" ] || [ "$$c" = "charts/nostr-thread-copier" ] || [ "$$c" = "charts/nostouch" ] || [ "$$c" = "charts/cluster-capacity" ]; then \
