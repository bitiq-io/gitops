...
lint: ## helm lint all charts
	@for c in $(CHARTS); do \
	  echo "==> helm lint $$c"; \
	if [ "$$c" = "charts/toy-service" ] || [ "$$c" = "charts/toy-web" ] || [ "$$c" = "charts/nostr-site" ] || [ "$$c" = "charts/couchbase-cluster" ] || [ "$$c" = "charts/strfry" ] || [ "$$c" = "charts/ollama" ] || [ "$$c" = "charts/nostr-query" ] || [ "$$c" = "charts/nostr-threads" ] || [ "$$c" = "charts/nostr-thread-copier" ] || [ "$$c" = "charts/nostouch" ] || [ "$$c" = "charts/cluster-capacity" ]; then \
